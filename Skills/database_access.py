...
@registry.register(
    ...
    parameters={
        ...
        "db_name": {"type": "string", "description": "Name of the local database file (default: parmana_default.db)"}
    }
)
def execute_sql(query: str, db_name: str = "parmana_default.db") -> str:
    try:
